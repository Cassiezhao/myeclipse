...
public class UserDAO extends HibernateDaoSupport {
	...
	public List<User> findByUsernum(Object usernum) {
		return findByProperty(USERNUM, usernum);
	}

	public List<User> findByUserpower(Object userpower) {
		return findByProperty(USERPOWER, userpower);
	}
	...
	public List<User> findByConnect(Object connect) {
		return findByProperty(CONNECT, connect);
	}
