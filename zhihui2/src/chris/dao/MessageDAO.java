...
public class MessageDAO extends HibernateDaoSupport  {
		...
		//property constants
	public static final String GUIDEMNUM = "guidemnum";
    ...
    public List<Message> findByExample(Message instance) {
        ...
        try {
            List<Message> results = (List<Message>) getHibernateTemplate().findByExample(instance); 
	...
	public List<Message> findByGuidemnum(Object guidemnum
	) {
		return findByProperty(GUIDEMNUM, guidemnum
		);
	}
