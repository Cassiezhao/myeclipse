...
P {
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-167" data-genuitec-path="/zhihui2/WebRoot/error.jsp">
	<jsp:include page="common.jsp"/>
	<DIV data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-167" data-genuitec-path="/zhihui2/WebRoot/error.jsp">
