...
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=DGNFeh22K1TSexlaulHV9vA4l7NK91Hu&services=true"></script>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-188" data-genuitec-path="/zhihui2/WebRoot/guidemanage/guidePathAnalysis.jsp">	
	<jsp:include page="../common2.jsp"/>
				<!--slide bar end-->
				
				
				<!-- main start-->
				<div id="main-content" class="main-content col-md-10" style="border:1px solid #f2e1e8;border-width:0 0 0 1px;padding-left:0px;background-color:#ffffff;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-188" data-genuitec-path="/zhihui2/WebRoot/guidemanage/guidePathAnalysis.jsp">
