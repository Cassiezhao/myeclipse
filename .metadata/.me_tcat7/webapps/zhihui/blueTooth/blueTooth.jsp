...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-32" data-genuitec-path="/zhihui2/WebRoot/blueTooth/blueTooth.jsp">
	<jsp:include page="../common2.jsp"/>
			<!--slide bar end-->

			<!--main content start-->
			<div id="main-content" class="main-content col-md-10"
				style="border:1px solid #f2e1e8;border-width:0 0 0 1px;padding-left:0px;background-color:#ffffff" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-32" data-genuitec-path="/zhihui2/WebRoot/blueTooth/blueTooth.jsp">
